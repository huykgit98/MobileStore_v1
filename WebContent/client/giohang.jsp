			...
			<table id="cart" class="table table-hover table-condensed">
							...
							<c:forEach items="${sessionScope.carts}" var="cartItem" varStatus="status">
								<tr>
									...
									<td data-th="Subtotal" class="text-center">${cartItem.product.price * cartItem.qty}</td>
									<td class="actions" data-th="">
									<a class="btn btn-danger btn-xs" href="<c:url value='/remove-cart?idP=${cartItem.product.id}'/>"
					onclick="return confirm('Are you sure?')"><span class="glyphicon glyphicon-remove-circle"></span> Remove</a>
							...
							<tfoot>
								...
								<tr>
									...
									<td class="hidden-xs text-center"><strong>Grand Total 243</strong></td>
